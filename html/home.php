                            ...
                            <ul class="price-list">
                                ...
                                <li class="clickable-item">
                                    <div id='commodity-row'>     
                                        ...
                                        <div class="commodity-price-home"><span id="wellMilledRiceLatestPrice"></span></div>
                                ...
                                <li class="clickable-item">
                                    <div id='commodity-row'>     
                                        ...
                                        <div class="commodity-price-home"><span id="tomatoLatestPrice"></span></div>
                                ...
                                <li class="clickable-item">
                                    <div id='commodity-row'>     
                                        ...
                                        <div class="list-logo">
                                            <img src="../images/specific_commodity/whole_chicken.png" alt="Chicken Logo" class="commodity-logo">
                                        </div>
                                        <div class="commodity-name">Whole Chicken</div>
                                        <div class="commodity-price-home"><span id="wholeChickenLatestPrice"></span></div>
                                ...
                                <li class="clickable-item">
                                    <div id='commodity-row'>     
                                        ...
                                        <div class="commodity-price-home"><span id="bangusLatestPrice"></span></div>
                                ...
                                <li class="clickable-item">
                                    <div id='commodity-row'>     
                                        ...
                                        <div class="list-logo">
                                            <img src="../images/specific_commodity/banana_lakatan.png" alt="Fruit Logo" class="commodity-logo">
                                        </div>
                                        <div class="commodity-name">Banana</div>
                                        <div class="commodity-price-home"><span id="bananaLakatanLatestPrice"></span></div>
...
<!-- Get latest prices of top commodities -->
<script src="../js/top_prices.js"></script>
