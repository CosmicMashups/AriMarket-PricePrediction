...
fetch('../../json/well_milled_rice.json')
    ...
    .then(data => {
        ...
        const wellMilledRiceFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedWellMilledRiceFirstDate = formatDate(wellMilledRiceFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('wellMilledRiceFirstDate').innerText = `As of ${formattedWellMilledRiceFirstDate}`;
