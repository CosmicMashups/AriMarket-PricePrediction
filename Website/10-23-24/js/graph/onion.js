...
fetch('../../json/onion.json')
    ...
    .then(data => {
        ...
        const onionFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedOnionFirstDate = formatDate(onionFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('onionFirstDate').innerText = `As of ${formattedOnionFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(onionChart, newTheme);
        });
    })
    .catch(error => {
