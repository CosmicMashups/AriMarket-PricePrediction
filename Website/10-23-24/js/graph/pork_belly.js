...
fetch('../../json/pork_belly.json')
    ...
    .then(data => {
        ...
        const porkBellyFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedPorkBellyFirstDate = formatDate(porkBellyFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('porkBellyFirstDate').innerText = `As of ${formattedPorkBellyFirstDate}`;
