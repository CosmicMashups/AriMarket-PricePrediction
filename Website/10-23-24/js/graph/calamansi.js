...
fetch('../../json/calamansi.json')
    ...
    .then(data => {
        ...
        const calamansiFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedCalamansiFirstDate = formatDate(calamansiFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('calamansiFirstDate').innerText = `As of ${formattedCalamansiFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(calamansiChart, newTheme);
        });
    })
    .catch(error => {
