...
fetch('../../json/mango.json')
    ...
    .then(data => {
        ...
        const mangoFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedMangoFirstDate = formatDate(mangoFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('mangoFirstDate').innerText = `As of ${formattedMangoFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(mangoChart, newTheme);
        });
    })
    .catch(error => {
