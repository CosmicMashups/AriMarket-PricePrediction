...
fetch('../../json/carrots.json')
    ...
    .then(data => {
        ...
        const carrotsFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedCarrotsFirstDate = formatDate(carrotsFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('carrotsFirstDate').innerText = `As of ${formattedCarrotsFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(carrotsChart, newTheme);
        });
    })
    .catch(error => {
