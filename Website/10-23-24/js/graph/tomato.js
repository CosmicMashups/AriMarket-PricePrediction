...
fetch('../../json/tomato.json')
    ...
    .then(data => {
        ...
        const tomatoFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedTomatoFirstDate = formatDate(tomatoFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('tomatoFirstDate').innerText = `As of ${formattedTomatoFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(tomatoChart, newTheme);
        });
    })
    .catch(error => {
