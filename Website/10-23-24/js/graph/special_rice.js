...
fetch('../../json/special_rice.json')
    ...
    .then(data => {
        ...
        const specialRiceFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedSpecialRiceFirstDate = formatDate(specialRiceFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('specialRiceFirstDate').innerText = `As of ${formattedSpecialRiceFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(specialRiceChart, newTheme);
        });
    })
    .catch(error => {
