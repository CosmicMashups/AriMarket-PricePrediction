...
fetch('../../json/beef_rump.json')
    ...
    .then(data => {
        ...
        const beefRumpFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedBeefRumpFirstDate = formatDate(beefRumpFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('beefRumpFirstDate').innerText = `As of ${formattedBeefRumpFirstDate}`;
