...
fetch('../../json/banana_lakatan.json')
    ...
    .then(data => {
        ...
        const bananaLakatanFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedBananaLakatanFirstDate = formatDate(bananaLakatanFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('bananaLakatanFirstDate').innerText = `As of ${formattedBananaLakatanFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(bananaLakatanChart, newTheme);
        });
    })
    .catch(error => {
