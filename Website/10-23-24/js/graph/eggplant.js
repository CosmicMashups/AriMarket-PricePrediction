...
fetch('../../json/eggplant.json')
    ...
    .then(data => {
        ...
        const eggplantFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedEggplantFirstDate = formatDate(eggplantFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('eggplantFirstDate').innerText = `As of ${formattedEggplantFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(eggplantChart, newTheme);
        });
    })
    .catch(error => {
