...
fetch('../../json/cabbage.json')
    ...
    .then(data => {
        ...
        const cabbageFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedCabbageFirstDate = formatDate(cabbageFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('cabbageFirstDate').innerText = `As of ${formattedCabbageFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(cabbageChart, newTheme);
        });
    })
    .catch(error => {
