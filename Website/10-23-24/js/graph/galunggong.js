...
fetch('../../json/galunggong.json')
    ...
    .then(data => {
        ...
        const galunggongFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedGalunggongFirstDate = formatDate(galunggongFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('galunggongFirstDate').innerText = `As of ${formattedGalunggongFirstDate}`;
