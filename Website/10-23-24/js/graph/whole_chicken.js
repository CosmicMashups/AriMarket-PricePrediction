...
fetch('../../json/whole_chicken.json')
    ...
    .then(data => {
        ...
        const wholeChickenFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedWholeChickenFirstDate = formatDate(wholeChickenFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('wholeChickenFirstDate').innerText = `As of ${formattedWholeChickenFirstDate}`;
