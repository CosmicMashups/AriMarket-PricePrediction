...
fetch('../../json/pork_ham.json')
    ...
    .then(data => {
        ...
        const porkKasimFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedPorkKasimFirstDate = formatDate(porkKasimFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('porkKasimFirstDate').innerText = `As of ${formattedPorkKasimFirstDate}`;
