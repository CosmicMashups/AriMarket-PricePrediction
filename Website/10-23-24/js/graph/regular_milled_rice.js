...
fetch('../../json/regular_milled_rice.json')
    ...
    .then(data => {
        ...
        const regularMilledRiceFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedRegularMilledRiceFirstDate = formatDate(regularMilledRiceFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('regularMilledRiceFirstDate').innerText = `As of ${formattedRegularMilledRiceFirstDate}`;
