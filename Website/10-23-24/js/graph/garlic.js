...
fetch('../../json/garlic.json')
    ...
    .then(data => {
        ...
        const garlicFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedGarlicFirstDate = formatDate(garlicFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('garlicFirstDate').innerText = `As of ${formattedGarlicFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(garlicChart, newTheme);
        });
    })
    .catch(error => {
