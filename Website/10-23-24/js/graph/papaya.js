...
fetch('../../json/papaya.json')
    ...
    .then(data => {
        ...
        const papayaFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedPapayaFirstDate = formatDate(papayaFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('papayaFirstDate').innerText = `As of ${formattedPapayaFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(papayaChart, newTheme);
        });
    })
    .catch(error => {
