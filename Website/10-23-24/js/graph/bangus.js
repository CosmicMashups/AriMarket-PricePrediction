...
fetch('../../json/bangus.json')
    ...
    .then(data => {
        ...
        const bangusFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedBangusFirstDate = formatDate(bangusFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('bangusFirstDate').innerText = `As of ${formattedBangusFirstDate}`;
