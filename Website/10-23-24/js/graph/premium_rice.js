...
fetch('../../json/premium_rice.json')
    ...
    .then(data => {
        ...
        const premiumRiceFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedPremiumRiceFirstDate = formatDate(premiumRiceFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('premiumRiceFirstDate').innerText = `As of ${formattedPremiumRiceFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(premiumRiceChart, newTheme);
        });
    })
    .catch(error => {
