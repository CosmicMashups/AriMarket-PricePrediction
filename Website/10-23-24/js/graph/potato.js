...
fetch('../../json/white_potato.json')
    ...
    .then(data => {
        ...
        const whitePotatoFirstPrice = Math.round(prices[0] * 100) / 100;
        ...
        const formattedWhitePotatoFirstDate = formatDate(whitePotatoFirstDate);

        // Displaying the first values in HTML elements
        document.getElementById('whitePotatoFirstDate').innerText = `As of ${formattedWhitePotatoFirstDate}`;
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            updateChartTheme(whitePotatoChart, newTheme);
        });
    })
    .catch(error => {
