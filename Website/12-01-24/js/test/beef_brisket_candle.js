...
fetch('../../json/beef_brisket.json')
    ...
    .then(data => {
        ...
        const openPrices = data.open_prices;
        ...
        document.getElementById('beefBrisketCandlestick').width = chartWidth;
        ...
        const ctxCandlestick = document.getElementById('beefBrisketCandlestick').getContext('2d');
        const candlestickChart = new Chart(ctxCandlestick, {
        ...
        toggleSwitch.addEventListener('change', () => {
            ...
            [lineChart, scatterChart, pieDonutChart, candlestickChart, histogramChart].forEach(chart => updateChartTheme(chart, newTheme));
        });
    })
    .catch(error => {
