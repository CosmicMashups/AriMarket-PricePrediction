    ...
    fetch('../../json/calamansi.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'calamansiFirstDate'
            ).innerText = `As of ${calamansiFormattedFirstDate}`;
            document.getElementById(
                'calamansiFirstPrice'
            ).innerText = `₱${calamansiFirstPrice}/kg`;
            document.getElementById(
                'calamansiFirstHighPrice'
            ).innerText = `₱${calamansiFirstHighPrice}/kg`;
            document.getElementById(
                'calamansiFirstLowPrice'
            ).innerText = `₱${calamansiFirstLowPrice}/kg`;
