...
function updateChart() {
    ...
    fetch('../../json/alumahan.json')
        ...
        .then((data) => {
            ...
            const alumahanFormattedFirstDate = formatDate(alumahanFirstDate);

            document.getElementById(
                'alumahanFirstDate'
            ).innerText = `As of ${alumahanFormattedFirstDate}`;
            document.getElementById(
                'alumahanFirstPrice'
            ).innerText = `₱${alumahanFirstPrice}/kg`;
            document.getElementById(
                'alumahanFirstHighPrice'
            ).innerText = `₱${alumahanFirstHighPrice}/kg`;
            document.getElementById(
                'alumahanFirstLowPrice'
            ).innerText = `₱${alumahanFirstLowPrice}/kg`;
