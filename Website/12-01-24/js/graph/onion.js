    ...
    fetch('../../json/red_onion.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'onionFirstDate'
            ).innerText = `As of ${onionFormattedFirstDate}`;
            document.getElementById(
                'onionFirstPrice'
            ).innerText = `₱${onionFirstPrice}/kg`;
            document.getElementById(
                'onionFirstHighPrice'
            ).innerText = `₱${onionFirstHighPrice}/kg`;
            document.getElementById(
                'onionFirstLowPrice'
            ).innerText = `₱${onionFirstLowPrice}/kg`;
