    ...
    fetch('../../json/pork_belly.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'porkBellyFirstDate'
            ).innerText = `As of ${porkBellyFormattedFirstDate}`;
            document.getElementById(
                'porkBellyFirstPrice'
            ).innerText = `₱${porkBellyFirstPrice}/kg`;
            document.getElementById(
                'porkBellyFirstHighPrice'
            ).innerText = `₱${porkBellyFirstHighPrice}/kg`;
            document.getElementById(
                'porkBellyFirstLowPrice'
            ).innerText = `₱${porkBellyFirstLowPrice}/kg`;
