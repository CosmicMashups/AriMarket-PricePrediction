    ...
    fetch('../../json/garlic.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'garlicFirstDate'
            ).innerText = `As of ${garlicFormattedFirstDate}`;
            document.getElementById(
                'garlicFirstPrice'
            ).innerText = `₱${garlicFirstPrice}/kg`;
            document.getElementById(
                'garlicFirstHighPrice'
            ).innerText = `₱${garlicFirstHighPrice}/kg`;
            document.getElementById(
                'garlicFirstLowPrice'
            ).innerText = `₱${garlicFirstLowPrice}/kg`;
