    ...
    fetch('../../json/bangus.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'bangusFirstDate'
            ).innerText = `As of ${bangusFormattedFirstDate}`;
            document.getElementById(
                'bangusFirstPrice'
            ).innerText = `₱${bangusFirstPrice}/kg`;
            document.getElementById(
                'bangusFirstHighPrice'
            ).innerText = `₱${bangusFirstHighPrice}/kg`;
            document.getElementById(
                'bangusFirstLowPrice'
            ).innerText = `₱${bangusFirstLowPrice}/kg`;
