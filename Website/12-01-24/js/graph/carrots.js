    ...
    fetch('../../json/carrots.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'carrotsFirstDate'
            ).innerText = `As of ${carrotsFormattedFirstDate}`;
            document.getElementById(
                'carrotsFirstPrice'
            ).innerText = `₱${carrotsFirstPrice}/kg`;
            document.getElementById(
                'carrotsFirstHighPrice'
            ).innerText = `₱${carrotsFirstHighPrice}/kg`;
            document.getElementById(
                'carrotsFirstLowPrice'
            ).innerText = `₱${carrotsFirstLowPrice}/kg`;
