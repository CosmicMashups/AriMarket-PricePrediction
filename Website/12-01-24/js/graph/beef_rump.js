    ...
    fetch('../../json/beef_rump.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'beefRumpFirstDate'
            ).innerText = `As of ${beefRumpFormattedFirstDate}`;
            document.getElementById(
                'beefRumpFirstPrice'
            ).innerText = `₱${beefRumpFirstPrice}/kg`;
            document.getElementById(
                'beefRumpFirstHighPrice'
            ).innerText = `₱${beefRumpFirstHighPrice}/kg`;
            document.getElementById(
                'beefRumpFirstLowPrice'
            ).innerText = `₱${beefRumpFirstLowPrice}/kg`;
