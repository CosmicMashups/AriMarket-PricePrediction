    ...
    fetch('../../json/papaya.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'papayaFirstDate'
            ).innerText = `As of ${papayaFormattedFirstDate}`;
            document.getElementById(
                'papayaFirstPrice'
            ).innerText = `₱${papayaFirstPrice}/kg`;
            document.getElementById(
                'papayaFirstHighPrice'
            ).innerText = `₱${papayaFirstHighPrice}/kg`;
            document.getElementById(
                'papayaFirstLowPrice'
            ).innerText = `₱${papayaFirstLowPrice}/kg`;
