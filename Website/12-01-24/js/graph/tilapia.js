    ...
    fetch('../../json/tilapia.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'tilapiaFirstDate'
            ).innerText = `As of ${tilapiaFormattedFirstDate}`;
            document.getElementById(
                'tilapiaFirstPrice'
            ).innerText = `₱${tilapiaFirstPrice}/kg`;
            document.getElementById(
                'tilapiaFirstHighPrice'
            ).innerText = `₱${tilapiaFirstHighPrice}/kg`;
            document.getElementById(
                'tilapiaFirstLowPrice'
            ).innerText = `₱${tilapiaFirstLowPrice}/kg`;
