    ...
    fetch('../../json/cabbage.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'cabbageFirstDate'
            ).innerText = `As of ${cabbageFormattedFirstDate}`;
            document.getElementById(
                'cabbageFirstPrice'
            ).innerText = `₱${cabbageFirstPrice}/kg`;
            document.getElementById(
                'cabbageFirstHighPrice'
            ).innerText = `₱${cabbageFirstHighPrice}/kg`;
            document.getElementById(
                'cabbageFirstLowPrice'
            ).innerText = `₱${cabbageFirstLowPrice}/kg`;
