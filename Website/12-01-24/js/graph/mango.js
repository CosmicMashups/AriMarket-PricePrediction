    ...
    fetch('../../json/mango.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'mangoFirstDate'
            ).innerText = `As of ${mangoFormattedFirstDate}`;
            document.getElementById(
                'mangoFirstPrice'
            ).innerText = `₱${mangoFirstPrice}/kg`;
            document.getElementById(
                'mangoFirstHighPrice'
            ).innerText = `₱${mangoFirstHighPrice}/kg`;
            document.getElementById(
                'mangoFirstLowPrice'
            ).innerText = `₱${mangoFirstLowPrice}/kg`;
