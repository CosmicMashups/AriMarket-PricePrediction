    ...
    fetch('../../json/pork_kasim.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'porkKasimFirstDate'
            ).innerText = `As of ${porkKasimFormattedFirstDate}`;
            document.getElementById(
                'porkKasimFirstPrice'
            ).innerText = `₱${porkKasimFirstPrice}/kg`;
            document.getElementById(
                'porkKasimFirstHighPrice'
            ).innerText = `₱${porkKasimFirstHighPrice}/kg`;
            document.getElementById(
                'porkKasimFirstLowPrice'
            ).innerText = `₱${porkKasimFirstLowPrice}/kg`;
