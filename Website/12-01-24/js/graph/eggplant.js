    ...
    fetch('../../json/eggplant.json')
        ...
        .then((data) => {
            ...
            document.getElementById(
                'eggplantFirstDate'
            ).innerText = `As of ${eggplantFormattedFirstDate}`;
            document.getElementById(
                'eggplantFirstPrice'
            ).innerText = `₱${eggplantFirstPrice}/kg`;
            document.getElementById(
                'eggplantFirstHighPrice'
            ).innerText = `₱${eggplantFirstHighPrice}/kg`;
            document.getElementById(
                'eggplantFirstLowPrice'
            ).innerText = `₱${eggplantFirstLowPrice}/kg`;
