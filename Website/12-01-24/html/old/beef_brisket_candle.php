...
<body>
            ...
            <div id='content-single-container'>
                ...
                <div id='content-center-container'>
                        ...
                        <div id="widget-commodity-graph">
                            ...
                            <div>
                                ...
                                <select id="filterType">
                                    <option value="line" selected>All Time</option>
                                    <option value="scatter">Year</option>
                                    <option value="candlestick">Month</option>
                                </select>
                                Chart:
                                <select id="chartType">
                    ...
                    <div id='widget-commodity-scatter-pie'> 
                        ...
                        <!-- Container: Graph -->   
                        <div id='widget-commodity-full'>
                            <h2>Candlestick Plot for Beef Brisket (Meat)</h2>
                            <div class="chart-full">
                                <canvas class="commodity-chart" id="beefBrisketCandlestick" width="300" height="400"></canvas>
                            </div>
                        </div>    
    ...
    <script src="../../js/graph/beef_brisket_candle.js"></script>
