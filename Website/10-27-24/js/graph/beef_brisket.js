...
fetch('../../json/beef_brisket.json')
    ...
    .then(data => {
        ...
        const beefBrisketFirstPrice = Math.round(averagePrices[0] * 100) / 100;
        const beefBrisketFirstHighPrice = Math.round(highPrices[0] * 100) / 100;
        const beefBrisketFirstLowPrice = Math.round(lowPrices[0] * 100) / 100;
