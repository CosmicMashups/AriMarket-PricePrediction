...
<body>
  <div id='container'>
            ...
            <div id='content-center-container'>
                ...
                <div id='widget-commodity-header'>
                    ...
                    <div id='specific-commodity-content'>
                        ...
                        <div id='specific-commodity-label-date'>
                            ...
                            <!-- Container: Label -->
                            <div id='specific-commodity-label'><h1>Mango</h1></div>
                ...
                <div id='widget-commodity-graph-types'> 
                    ...
                    <div id='widget-commodity-graph'>
                        <h2>Price Forecast for Mango (Fruits)</h2>
                        <div class="chart">
                            <canvas class="commodity-chart" id="mangoChart" width="750" height="400"></canvas>
                        </div>
                    </div>    
                    ...
                    <div id='widget-commodity-types'>
                        ...
                        <a>
                            <div id='specific-commodity-types-rectangle' class='active'><h3>Mango</h3></div>
                        </a>
    ...
    <script src="../../js/graph/mango.js"></script>
