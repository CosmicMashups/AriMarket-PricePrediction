...
<head>
    ...
    <title>Banana (Lakatan) | AriMarket</title>
...
<body>
  <div id='container'>
            ...
            <div id='content-center-container'>
                ...
                <div id='widget-commodity-header'>
                    ...
                    <div id='specific-commodity-logo'>
                        <img src="../../images/commodity/fruits.png" alt="Fruits Logo" class="specific-commodity-logo-img">
                    </div>
                    ...
                    <div id='specific-commodity-content'>
                        ...
                        <div id='specific-commodity-label-date'>
                            ...
                            <!-- Container: Label -->
                            <div id='specific-commodity-label'><h1>Banana (Lakatan)</h1></div>
                            ...
                            <div id='specific-commodity-date'>
                                ...
                                <div id='specific-commodity-date-rectangle'>
                                    <h3 id='bananaLakatanFirstDate'></h3>
                                </div>
                            </div>
                        ...
                        <div id='specific-commodity-prices'>       
                            ...
                            <div id='specific-commodity-average-price' class='priceTypeTooltip'>                        
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="bananaLakatanFirstPrice"></h2>
                                    </div>
                                </div>                        
                            ...
                            <div id='specific-commodity-high-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="bananaLakatanFirstHighPrice"></h2>
                                    </div>
                                </div>
                            ...
                            <div id='specific-commodity-low-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="bananaLakatanFirstLowPrice"></h2>
                                    </div>                                    
                                </div>
                ...
                <div id='widget-commodity-graph-types'> 
                    ...
                    <div id='widget-commodity-graph'>
                        <h2>Price Forecast for Banana Lakatan (Fruits)</h2>
                        <div class="chart">
                            <canvas class="commodity-chart" id="bananaLakatanChart" width="750" height="400"></canvas>
                        </div>
                    </div>    
                    ...
                    <div id='widget-commodity-types'>
                        ...
                        <a>
                            <div id='specific-commodity-types-rectangle' class='active'><h3>Banana</h3></div>
                        </a>

                        <a href='calamansi.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Calamansi</h3></div>
                        </a>

                        <a href='mango.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Mango</h3></div>
                        </a>

                        <a href='papaya.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Papaya</h3></div>
                        </a>
    ...
    <script src="../../js/graph/banana_lakatan.js"></script>
