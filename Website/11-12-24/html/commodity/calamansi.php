...
<head>
    ...
    <title>Calamansi | AriMarket</title>
...
<body>
  <div id='container'>
            ...
            <div id='content-center-container'>
                ...
                <div id='widget-commodity-header'>
                    ...
                    <div id='specific-commodity-content'>
                        ...
                        <div id='specific-commodity-label-date'>
                            ...
                            <!-- Container: Label -->
                            <div id='specific-commodity-label'><h1>Calamansi</h1></div>
                        ...
                        <div id='specific-commodity-prices'>       
                            ...
                            <div id='specific-commodity-high-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="calamansiFirstHighPrice"></h2>
                                    </div>
                                </div>
                            ...
                            <div id='specific-commodity-low-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="calamansiFirstLowPrice"></h2>
                                    </div>                                    
                                </div>
                ...
                <div id='widget-commodity-graph-types'> 
                    ...
                    <div id='widget-commodity-graph'>
                        <h2>Price Forecast for Calamansi (Fruits)</h2>
                        <div class="chart">
                            <canvas class="commodity-chart" id="calamansiChart" width="750" height="400"></canvas>
                        </div>
                    </div>    
                    ...
                    <div id='widget-commodity-types'>
                        ...
                        <a href='banana_lakatan.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Banana</h3></div>
                        </a>

                        <a>
                            <div id='specific-commodity-types-rectangle' class='active'><h3>Calamansi</h3></div>
                        </a>
    ...
    <script src="../../js/graph/calamansi.js"></script>
