...
<body>
  <div id='container'>
            ...
            <div id='content-center-container'>
                ...
                <div id='widget-commodity-header'>
                    ...
                    <div id='specific-commodity-logo'>
                        <img src="../../images/commodity/vegetables.png" alt="Vegetables Logo" class="specific-commodity-logo-img">
                    </div>
                    ...
                    <div id='specific-commodity-content'>
                        ...
                        <div id='specific-commodity-label-date'>
                            ...
                            <!-- Container: Label -->
                            <div id='specific-commodity-label'><h1>Potato</h1></div>
                        ...
                        <div id='specific-commodity-prices'>       
                            ...
                            <div id='specific-commodity-average-price' class='priceTypeTooltip'>                        
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="whitePotatoFirstPrice"></h2>
                                    </div>
                                </div>
                            ...
                            <div id='specific-commodity-high-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="whitePotatoFirstHighPrice"></h2>
                                    </div>
                                </div>
                            ...
                            <div id='specific-commodity-low-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="whitePotatoFirstLowPrice"></h2>
                                    </div>                                    
                                </div>
                ...
                <div id='widget-commodity-graph-types'> 
                    ...
                    <div id='widget-commodity-graph'>
                        <h2>Price Forecast for Potato (Vegetables)</h2>
                        <div class="chart">
                            <canvas class="commodity-chart" id="whitePotatoChart" width="750" height="400"></canvas>
                        </div>
                    </div>    
                    ...
                    <div id='widget-commodity-types'>
                        ...
                        <a href='cabbage.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Cabbage</h3></div>
                        </a>

                        <a href='eggplant.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Carrots</h3></div>
                        </a>

                        <a href='eggplant.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Eggplant</h3></div>
                        </a>

                        <a href='tomato.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Tomato</h3></div>
                        </a>

                        <a>
                            <div id='specific-commodity-types-rectangle' class='active'><h3>Potato</h3></div>
                        </a>
    ...
    <script src="../../js/graph/potato.js"></script>
