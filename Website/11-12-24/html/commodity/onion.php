...
<head>
    ...
    <title>Red Onion | AriMarket</title>
...
<body>
  <div id='container'>
            ...
            <div id='content-center-container'>
                ...
                <div id='widget-commodity-header'>
                    ...
                    <div id='specific-commodity-content'>
                        ...
                        <div id='specific-commodity-label-date'>
                            ...
                            <!-- Container: Label -->
                            <div id='specific-commodity-label'><h1>Red Onion</h1></div>
                ...
                <div id='widget-commodity-graph-types'> 
                    ...
                    <div id='widget-commodity-graph'>
                        <h2>Price Forecast for Onion (Spices)</h2>
                        <div class="chart">
                            <canvas class="commodity-chart" id="onionChart" width="750" height="400"></canvas>
                        </div>
                    </div>    
                    ...
                    <div id='widget-commodity-types'>
                        ...
                        <a href='garlic.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Garlic</h3></div>
                        </a>

                        <a>
                            <div id='specific-commodity-types-rectangle' class='active'><h3>Onion</h3></div>
                        </a>
    ...
    <script src="../../js/graph/onion.js"></script>
