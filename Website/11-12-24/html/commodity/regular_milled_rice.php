...
<head>
    ...
    <title>Regular-Milled Rice | AriMarket</title>
...
<body>
  <div id='container'>
            ...
            <div id='content-center-container'>
                ...
                <div id='widget-commodity-header'>
                    ...
                    <div id='specific-commodity-logo'>
                        <img src="../../images/commodity/rice.png" alt="Rice Logo" class="specific-commodity-logo-img">
                    </div>
                    ...
                    <div id='specific-commodity-content'>
                        ...
                        <div id='specific-commodity-label-date'>
                            ...
                            <!-- Container: Label -->
                            <div id='specific-commodity-label'><h1>Regular-Milled Rice</h1></div>
                            ...
                            <div id='specific-commodity-date'>
                                ...
                                <div id='specific-commodity-date-rectangle'>
                                    <h3 id='regularMilledRiceFirstDate'></h3>
                                </div>
                            </div>
                        ...
                        <div id='specific-commodity-prices'>       
                            ...
                            <div id='specific-commodity-average-price' class='priceTypeTooltip'>                        
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="regularMilledRiceFirstPrice"></h2>
                                    </div>
                                </div>
                            ...
                            <div id='specific-commodity-high-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="regularMilledRiceFirstHighPrice"></h2>
                                    </div>
                                </div>
                            ...
                            <div id='specific-commodity-low-price' class='priceTypeTooltip'>
                                <div id='specific-commodity-prices-rectangle'>
                                    ...
                                    <div id='specific-commodity-prices-label'>
                                        <h2 id="regularMilledRiceFirstLowPrice"></h2>
                                    </div>                                    
                                </div>
                ...
                <div id='widget-commodity-graph-types'> 
                    ...
                    <div id='widget-commodity-graph'>
                        <h2>Price Forecast for Regular-Milled Rice (Rice)</h2>
                        <div class="chart">
                            <canvas class="commodity-chart" id="regularMilledRiceChart" width="750" height="400"></canvas>
                        </div>
                    </div>
                    ...
                    <div id='widget-commodity-types'>
                        ...
                        <a>
                            <div id='specific-commodity-types-rectangle' class='active'><h3>Regular-Milled</h3></div>
                        </a>

                        <a href='well_milled_rice.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Well-Milled</h3></div>
                        </a>

                        <a href='premium_rice.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Premium</h3></div>
                        </a>

                        <a href='special_rice.php'>
                            <div id='specific-commodity-types-rectangle'><h3>Special</h3></div>
                        </a>
    ...
    <script src="../../js/graph/regular_milled_rice.js"></script>
